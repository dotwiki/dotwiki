...
Rails.application.config.sorcery.configure do |config|
  ...
  # Default: `[]`
  #
  config.external_providers = [:twitter, :discord]
  ...
  config.twitter.callback_url = "https://www.dotwiki.xyz/oauth/callback/twitter"
  ...
  config.discord.callback_url = "https://www.dotwiki.xyz/oauth/callback?provider=discord"
