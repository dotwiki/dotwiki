...
ccc = <<-"EOS"
登場人物の名前は創作のほか、奇抜に見えるが実在する姓名が多用されている。
敵方である「鬼」については、身体破壊や人喰いなどのハードな描写が多い。
また、主人公の竈門炭治郎をはじめとする人間たちもシリアスとコメディの両側面が描かれている。

舞台は大正時代の日本。開国と文明開化から半世紀近くが経っていて、和洋が混在する。
都市部は発展しているが、地方部は旧時代が色濃く残る。
また廃刀令や科学文明の大正現代に夜に潜む鬼などいるわけがないなどの理由により、
政府不認可なので、鬼殺隊は表立った行動に制限がある。
dottowikiどっとうぃきドットウィキ
